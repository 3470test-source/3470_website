...
// expiry: tokenStore[token].expiry
...
// const safePath = path.join(__dirname,"private_pdfs",safeFile)

// if(!fs.existsSync(safePath))
// return res.status(404).send("File not found")

// console.log("PDF opened:",safeFile,"Time:",new Date())
...
// console.log("PDF opened:",file,"Time:",new Date())
